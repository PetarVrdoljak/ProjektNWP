		...
		<div id="users">
			<table>
				...
				while($row = @mysqli_fetch_array($result)) {
					print '
					<tr>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;id=' .$row['id']. '"><img src="user.png" alt="user"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;edit=' .$row['id']. '"><img src="edit.png" alt="uredi"></a></td>
						<td><a href="index.php?menu='.$menu.'&amp;action='.$action.'&amp;delete=' .$row['id']. '"><img src="delete.png" alt="obriši"></a></td>
						...
						<td>';
							if ($row['archive'] == 'Y') { print '<img src="inactive.png" alt="" title="" />'; }
                            else if ($row['archive'] == 'N') { print '<img src="active.png" alt="" title="" />'; }
						print '
						</td>
					</tr>';
				}
